...
## [3.0.2](https://github.com/docspecio/api/compare/3.0.1...3.0.2) (2026-04-27)


### Bug Fixes

* **deps:** unlock and lock dependencies ([e2e392a](https://github.com/docspecio/api/commit/e2e392ad2a9fbdc103df8d7d318628255527d0c4))
...
* text alignment ([271cb26](https://github.com/docspecio/api/commit/271cb2641399e4e0f1c2a4808d9f79c24781fae5))
...
* bullet list item ([122189b](https://github.com/docspecio/api/commit/122189bcb26f889967324aea3bb6986be1f69ac1))
* image alt to caption ([89d3f6d](https://github.com/docspecio/api/commit/89d3f6d6952c8a624817dad9fba154cdc865e36b))
* images ([e42438e](https://github.com/docspecio/api/commit/e42438ed1f7e4418ccb20c78df9887046e01f9dd))
* nested bullet list items ([6a22552](https://github.com/docspecio/api/commit/6a22552c60e852ded3665dc631240da51aaf8cd6))
* ordered list ([acfe78d](https://github.com/docspecio/api/commit/acfe78dbd8b5f5af6c972b1032faba75ab97780c))
* rename package docspec to docspec_api ([1be5bc6](https://github.com/docspecio/api/commit/1be5bc6d24429f129fd0fab746c7f36ea7a5e70f))
* support block quotes ([f29b40d](https://github.com/docspecio/api/commit/f29b40d88ac3dff346ef2465219ce998a449bb79))
* support external hyperlinks ([c4370f2](https://github.com/docspecio/api/commit/c4370f23a5757a0913a73a86cdf832aea50911ae))
* support for code blocks ([e15522d](https://github.com/docspecio/api/commit/e15522d0b0e38f5a9b51954a2a380c0be7e4f838))
* tables ([060d37c](https://github.com/docspecio/api/commit/060d37c88a4bfaff0d88e08d562633235d9ae121))


### Bug Fixes

* apk add unknown arguments in Dockerfile ([2c5399f](https://github.com/docspecio/api/commit/2c5399fdb70ae55b9b42871e4631e1542f826249))
* change message on 404 ([9b9b58a](https://github.com/docspecio/api/commit/9b9b58a53beb9ac656c4879903a16761c23d3140))
* **deps:** bump bandit from 1.7.0 to 1.8.0 ([#8](https://github.com/docspecio/api/issues/8)) ([357d599](https://github.com/docspecio/api/commit/357d599dfa0ca9c5e86453974c6b5ac69e81e9a4))
* **deps:** bump logger_json from 7.0.3 to 7.0.4 ([#5](https://github.com/docspecio/api/issues/5)) ([5bf9a45](https://github.com/docspecio/api/commit/5bf9a4515cbdd8d4a625dc6d2fd5ee7ab27f01a9))
* **deps:** bump nldoc_spec from 3.1.5 to 3.1.10 ([#6](https://github.com/docspecio/api/issues/6)) ([ab22f27](https://github.com/docspecio/api/commit/ab22f27b0dd0aa85a202123cb1473fc00ced1518))
* **deps:** bump nldoc_util from 1.0.13 to 1.0.15 ([#7](https://github.com/docspecio/api/issues/7)) ([246d0d5](https://github.com/docspecio/api/commit/246d0d527b32ff8f5f9bebd2a0ebb499f07d5724))
* do not convert images without any assets ([ca9d85a](https://github.com/docspecio/api/commit/ca9d85a7e6d38a5c1a3ce35486ccad249db80cf2))
* prevent tests jumping around ([71b38cd](https://github.com/docspecio/api/commit/71b38cd35956051af2b3e0328f016d4b0e6ffcc0))
* remove the blocknote conversion API from here ([2d9a030](https://github.com/docspecio/api/commit/2d9a030d29f16ca7d96cca8225dff0d6c0be6933))
* remove unused code ([fce5a0f](https://github.com/docspecio/api/commit/fce5a0f203324091a21f69093a44ecc700332c26))
* reversing ([b548077](https://github.com/docspecio/api/commit/b5480773699a8baa77633813986c502faa231a56))
* rowspan/colspan ([36cd084](https://github.com/docspecio/api/commit/36cd084efa8f8ef740f364f3481ceed6bfa6b8e8))
* start of app ([9372926](https://github.com/docspecio/api/commit/9372926b63bba1930879c21f1018cef4acdc496c))
* start of app ([77ea626](https://github.com/docspecio/api/commit/77ea626b40aed1713c630d381ce7a63fd57fbbec))
* styling and write some tests ([0ba4c3b](https://github.com/docspecio/api/commit/0ba4c3b7a1963882fb4b33c397af25e1a259547a))
* table cell wrapping ([ee7b364](https://github.com/docspecio/api/commit/ee7b364f8817f92a8f25070cc08609ef20a7201a))
* table spans ([ffaddab](https://github.com/docspecio/api/commit/ffaddaba858e0f14fe3110ddc68c54724b3dfdea))
* update dependencies ([4a65e56](https://github.com/docspecio/api/commit/4a65e56f77f8a94c0672ab915740abb30a501615))
* upload limit ([7c15749](https://github.com/docspecio/api/commit/7c15749b450c6302df87ccbc7cb7d12427efee05))

## [0.3.1](https://github.com/docspecio/api/compare/0.3.0...v0.3.1) (2025-11-15)
